...
export default function HammerspaceObjectives(props) {
    ...
    if (hammerspaceObjectives.data) {
        ...
        console.log('HammerspaceObjectives raw data:', hammerspaceObjectives.data);
        
        // Check if data is wrapped in a 'results' field
        const rawData = hammerspaceObjectives.data.results || hammerspaceObjectives.data;
                                    ...
                                    <>
                                        <TableRow 
                                            ...
                                            sx={{ 
                                                ...
                                                borderLeft: isRecent ? '4px solid #4caf50' : '4px solid white',
                                                cursor: 'pointer'
                                            }}
                                        ...
                                        >
                                            ...
                                            <TableCell>
                                                    ...
                                                    title={
                                                        <Box>
                                                            ...
                                                            <Typography variant="caption" sx={{ display: 'block', lineHeight: 1.4 }}>
                                                                {getObjectiveExplanation(objective.name)}
                                                            </Typography>
                                                            {objective.description && (
                                                                <Typography variant="caption" sx={{ display: 'block', mt: 0.5, fontStyle: 'italic', opacity: 0.9 }}>
                                                                    {objective.description}
                                                                </Typography>
                                                            )}
                                                            {objective.type && (
                                                ...
                                                >
                                                    <Typography variant="body2" sx={{ fontWeight: 'medium', cursor: 'help' }}>
                                                        {objective.name}
                                                    </Typography>
                                                </Tooltip>
                                            </TableCell>
